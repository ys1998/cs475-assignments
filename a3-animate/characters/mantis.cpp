...
namespace mantis {
    ...
    HNode* create_character(std::vector<HNode*> &joints) {
        ...
        /* ----------- Abdomen Begin ----------*/
        make_frustum(vertices, colors, normals,  0.4f, 0.4f, 0, 1.5f, colors::Light_Green, colors::Light_Green);
        shape_transform = glm::scale(glm::mat4(), glm::vec3(0.75, 0.75, 1.0));
        Rigid_Node* abdomen = new Rigid_Node(root, vertices, colors, normals, shape_transform);
        abdomen->set_name("Abdomen");
        abdomen->change_parameters(glm::vec3(), glm::vec3(0, 45.0f, 0));
        vertices.clear();   colors.clear();   normals.clear();
        /* ----------- Abdomen End ----------*/
        ...
        /* ----------- Chest Begin ----------*/
        make_egg(vertices, colors, normals,  1.25f, -0.25f, -0.75f, colors::Light_Green);
        ...
        Rigid_Node* chest = new Rigid_Node(chest_joint, vertices, colors, normals, shape_transform);
        ...
        /* ----------- Neck Begin ----------*/
        make_sphere(vertices, colors, normals,  0.3f, colors::Black);
        make_frustum(vertices, colors, normals,  0.4f, 0.4f, 0, 2.0f, colors::Light_Green, colors::Light_Green);
        shape_transform = glm::scale(glm::mat4(), glm::vec3(0.75, 0.75, 1.0));
        Rigid_Node* neck = new Rigid_Node(chest, vertices, colors, normals, shape_transform);
        ...
        /* ----------- Head Begin ----------*/
        make_frustum(vertices, colors, normals,  0.55f, 0.5f, -1.0f, 0.3f, colors::Light_Green, colors::Light_Green);
        shape_transform = glm::scale(glm::mat4(), glm::vec3(0.8, 1.0, 1.0));
        Rigid_Node* head = new Rigid_Node(head_joint, vertices, colors, normals, shape_transform);
        head->change_parameters(glm::vec3(0.3f, 0, 0.4f), glm::vec3(0, -60, 0));
        head->set_name("Head");
        vertices.clear();   colors.clear();   normals.clear();

        make_sphere(vertices, colors, normals,  0.55f, colors::Light_Green);
        Rigid_Node *h1 = new Rigid_Node(head, vertices, colors, normals, shape_transform);
        h1->change_parameters(glm::vec3(0, 0, -1.0f));
        vertices.clear();   colors.clear();   normals.clear();
        make_sphere(vertices, colors, normals, 0.5f, colors::Light_Green);
        Rigid_Node *h2 = new Rigid_Node(head, vertices, colors, normals, shape_transform);
        ...
        /* ----------- Eye Begin ----------*/
        make_sphere(vertices, colors, normals,  0.3f, colors::Yellow);
        shape_transform = glm::scale(glm::mat4(), glm::vec3(1.0, 1.3, 1.0));
        Rigid_Node* eye[] = {
            new Rigid_Node(head, vertices, colors, normals, shape_transform),
            new Rigid_Node(head, vertices, colors, normals, shape_transform),
        };
        ...
        /* ----------- Eyeball Begin ----------*/
        make_sphere(vertices, colors, normals,  0.2f, colors::Black);
        shape_transform = glm::mat4();
        Rigid_Node* eyeball[] = {
            new Rigid_Node(eye[0], vertices, colors, normals, shape_transform),
            new Rigid_Node(eye[1], vertices, colors, normals, shape_transform),
        };
        ...
        /* ----------- Mustache Begin ----------*/
        make_hemisphere(vertices, colors, normals,  0.25f, colors::Dark_Green);
        ...
        /* ----------- Tail Begin ----------*/
        make_sphere(vertices, colors, normals,  1.0f, colors::Light_Green);
        shape_transform = glm::scale(glm::mat4(), glm::vec3(0.6f, 1.0f, 3.0f));
        Rigid_Node* tail = new Rigid_Node(tail_joint, vertices, colors, normals, shape_transform);
        ...
        /* ----------- Leg upper Begin ----------*/
        make_frustum(vertices, colors, normals,  0.1f, 0.15f, 0, 1.8f, colors::Dark_Green, colors::Dark_Green);
        shape_transform = glm::mat4();
        Rigid_Node* leg_upper[] = {
            new Rigid_Node(leg_upper_joints[0], vertices, colors, normals, shape_transform),
            new Rigid_Node(leg_upper_joints[1], vertices, colors, normals, shape_transform),
            new Rigid_Node(leg_upper_joints[2], vertices, colors, normals, shape_transform),
            new Rigid_Node(leg_upper_joints[3], vertices, colors, normals, shape_transform),
        };
        ...
        /* ----------- Leg lower Begin ----------*/
        make_frustum(vertices, colors, normals,  0.15f, 0.1f, 0, 6.0f, colors::Dark_Green, colors::Dark_Green);
        shape_transform = glm::mat4();
        Rigid_Node* leg_lower[] = {
            new Rigid_Node(knee_joints[0], vertices, colors, normals, shape_transform),
            new Rigid_Node(knee_joints[1], vertices, colors, normals, shape_transform),
            new Rigid_Node(knee_joints[2], vertices, colors, normals, shape_transform),
            new Rigid_Node(knee_joints[3], vertices, colors, normals, shape_transform),
        };
        ...
        /* ----------- Arm Upper Begin ----------*/
        make_frustum(vertices, colors, normals,  0.2f, 0.2f, 0, 1.8f, colors::Dark_Green, colors::Dark_Green);
        shape_transform = glm::mat4();
        Rigid_Node* arm_upper[] = {
            new Rigid_Node(arm_upper_joints[0], vertices, colors, normals, shape_transform),
            new Rigid_Node(arm_upper_joints[1], vertices, colors, normals, shape_transform),
        };
        ...
        /* ----------- Forearm Begin ----------*/
        make_egg(vertices, colors, normals, 1.25f, -0.25f, -0.75f, colors::Dark_Green);
        ...
        Rigid_Node* forearm[] = {
            new Rigid_Node(elbow[0], vertices, colors, normals, shape_transform),
            new Rigid_Node(elbow[1], vertices, colors, normals, shape_transform),
        };
